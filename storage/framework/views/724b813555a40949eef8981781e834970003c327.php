...
<!--        <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="/admin"><i class="fa fa-dashboard"></i> <span>首页</span></a></li>
                    ...
                    <li class="treeview  <?php if(in_array($v['id'],$comData['openarr'])): ?> active <?php endif; ?>">
                        ...
                        <ul class="treeview-menu">
                            <?php foreach($comData[$v['id']] as $vv): ?>
                                <li <?php if(in_array($vv['id'],$comData['openarr'])): ?> class="active" <?php endif; ?>><a href="/<?php echo e($vv['name']); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i><?php echo e($vv['display_name']); ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
                <?php endforeach; ?>
