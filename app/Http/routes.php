...
Route::get('admin/school/down', ['as' => 'admin.school.down', 'uses' => 'Admin\SchoolController@down']); 
Route::get('admin/info/down', ['as' => 'admin.info.down', 'uses' => 'Admin\InfoController@down']); 
Route::get('admin/user/down', ['as' => 'admin.info.down', 'uses' => 'Admin\UserController@down']); 
